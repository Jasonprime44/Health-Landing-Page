        ...
        <div className="flex-grow flex flex-col justify-center mt-8">
          <section className="container mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <motion.h1
                className="text-4xl md:text-6xl font-bold mb-6 max-w-5xl mx-auto leading-tight px-4 relative z-10"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.3 }}
              >
                <span className="text-white">Cut No‑Shows by 40% & Attract</span>
                <br />
                <span className="text-white">More Patients with Our</span>
                <br />
              ...
              >
                <Button className="bg-[#E8D0A9] text-[#333333] rounded-sm px-5 py-3 hover:bg-[#d9c299] transition-all duration-300 ease-in-out w-40">
                  Let's Talk <span className="inline-block ml-1 transform -rotate-12">→</span>
                </Button>
              </motion.div>
            </div>

            {/* Stats Section - Moved up to reduce space */}
            <div className="mt-8">
              <StatsSection />
            </div>
          </section>
